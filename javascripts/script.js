...
/* EJEMPLO: <a href="http://vieques.elnuevodia.com/?ViewFullSite=true">Visita el sitio "desktop"</a> */
    ...
    if (!renderFullSite) {
        ...
        var mobilesite = "http://vieques.elnuevodia.com/m/";
        var locationhref = removeQueryString(location.href);
        //alert("location href after: " + locationhref);
        if (locationhref == "http://vieques.elnuevodia.com/") {
            mobilesite = "http://vieques.elnuevodia.com/m/";
        }
